...
function (_React$Component) {
  ...
  function GameResultModal() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClose", function () {
      _this.props.dispatch(_redux__WEBPACK_IMPORTED_MODULE_7__["actions"].baccaratCloseGameResult());
    });
    ...
    value: function render() {
      ...
      if (showGameResult) {
        _redux__WEBPACK_IMPORTED_MODULE_7__["actions"].myBalanceUpdateFromRemote().then(function (myBalance) {
          return _this2.props.dispatch(myBalance);
        });
      }
...
//# sourceMappingURL=baccarat.js.1be0dbc24d14dc1f196f.hot-update.js.map
...
var GameResultModal = (_dec = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(function (_ref) {
  var myBalance = _ref.myBalance,
      baccarat = _ref.baccarat;
  return {
    myBalance: myBalance,
    baccarat: baccarat
  };
...
function (_React$Component) {
  ...
  function GameResultModal() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(GameResultModal).apply(this, arguments));
  }
  ...
  _createClass(GameResultModal, [{
    ...
    value: function render() {
      ...
      if (showGameResult) {
        _redux__WEBPACK_IMPORTED_MODULE_7__["actions"].myBalanceUpdateFromRemote().then(function (myBalance) {
          return _this.props.dispatch(myBalance);
        });
      }
...
//# sourceMappingURL=baccarat.js.4a874c77e478d5fd50e5.hot-update.js.map
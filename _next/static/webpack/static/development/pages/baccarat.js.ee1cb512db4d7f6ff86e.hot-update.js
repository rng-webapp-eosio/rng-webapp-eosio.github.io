...
function (_React$Component2) {
  ...
  function GameTable() {
    ...
    _defineProperty(_assertThisInitialized(_this2), "getCard", function (cardNumber, index) {
      if (lodash__WEBPACK_IMPORTED_MODULE_6___default.a.isNil(cardNumber)) return '';
  ...
  _createClass(GameTable, [{
    ...
    //   this.setState({
    //     dealArea: {
    //       playerCards: [2, 5, 42].map((...params) => this.getCard(...params)),
    //       bankerCards: [9, 1, 25].map((...params) => this.getCard(...params)),
    //     }
    //   });
    // }
    value: function componentDidUpdate(prevProps) {
      var previousBaccaratGameStatus = _redux__WEBPACK_IMPORTED_MODULE_10__["selectors"].getBaccaratGameStatus(prevProps);
      var currentBaccaratGameStatus = _redux__WEBPACK_IMPORTED_MODULE_10__["selectors"].getBaccaratGameStatus(this.props); // console.log('[GameTable]', { previousBaccaratGameStatus, currentBaccaratGameStatus });
      // game state changed
      ...
      if (currentBaccaratGameStatus && previousBaccaratGameStatus && previousBaccaratGameStatus.gameState !== currentBaccaratGameStatus.gameState) {
        switch (currentBaccaratGameStatus.gameState) {
          case 'BACCARAT_GAME_STATE_RESULT':
            {
              var bankerCards = currentBaccaratGameStatus.gameResult.banker_card;
              var playerCards = currentBaccaratGameStatus.gameResult.player_card;
              this.setState({
                dealArea: {
    ...
    value: function render() {
      ...
      var _this$state$dealArea = this.state.dealArea,
          playerCards = _this$state$dealArea.playerCards,
          bankerCards = _this$state$dealArea.bankerCards;
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_base_container__WEBPACK_IMPORTED_MODULE_7__["default"], {
        ...
        item: true,
        xs: 6
      }, this.getCard(playerCards[0], 0)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__["Grid"], {
        item: true,
        xs: 6
      }, this.getCard(playerCards[1], 1))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        className: classes.thirdCard
      }, this.getCard(playerCards[2], 2))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__["Grid"], {
        item: true,
        xs: 2
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__["Grid"], {
        item: true,
        ...
        item: true,
        xs: 6
      }, this.getCard(bankerCards[0], 0)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__["Grid"], {
        item: true,
        xs: 6
      }, this.getCard(bankerCards[1], 1))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        className: classes.thirdCard
      }, this.getCard(bankerCards[2], 2))))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__["Grid"], {
        container: true
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__["Grid"], {
        item: true,
        xs: 5
...
//# sourceMappingURL=baccarat.js.ee1cb512db4d7f6ff86e.hot-update.js.map
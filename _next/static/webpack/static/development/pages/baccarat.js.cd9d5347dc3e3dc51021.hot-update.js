...
/* harmony import */ var _redux__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../redux */ "./redux/index.js");
var _dec, _class;
...
function (_React$Component) {
  ...
  function GameCounter() {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateCountdown", function () {
      var gameConfig = _redux__WEBPACK_IMPORTED_MODULE_6__["selectors"].getBaccaratGameConfig(_this.props);

      var timeEnd = _.get(gameConfig, 'time_end');

      if (timeEnd) {
        timeEnd = moment(timeEnd).utcOffset(0, true); // set the endTime to UTC+0

        var diff = timeEnd.diff(moment());
        var countdown = moment.utc(Math.max(0, diff)).format('mm:ss');
...
//# sourceMappingURL=baccarat.js.cd9d5347dc3e3dc51021.hot-update.js.map
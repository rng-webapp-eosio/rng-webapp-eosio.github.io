...
function (_React$Component2) {
  ...
  _createClass(GameTable, [{
    ...
    //       bankerCardSeat: [9, 1, 25].map((...params) => this.getCard(...params)),
    //     }
    //   });
    // }
          ...
          case 'BACCARAT_GAME_STATE_RESULT':
            {
              ...
              this.setState({
                dealArea: {
                  playerCardSeat: playerCard.map(function () {
                    return _this3.getCard.apply(_this3, arguments);
                  }),
                  bankerCardSeat: bankerCard.map(function () {
                    return _this3.getCard.apply(_this3, arguments);
                  })
                }
              });
...
//# sourceMappingURL=baccarat.js.69ebcfa5eddde4f91ee8.hot-update.js.map
...
var styles = {
  ...
  dealArea: {
    ...
    // opacity: 0.37,
    borderRadius: 2,
    backgroundImage: 'linear-gradient(70deg, rgba(0, 0, 0, 0.37),	rgba(41, 202, 74, 0))',
    textAlign: 'center',
    position: 'relative'
  },
  dealAreaTitle: {
...
function (_React$Component2) {
  ...
  _createClass(GameTable, [{
    ...
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {// const previousBaccaratGameStatus = selectors.getBaccaratGameStatus(prevProps);
...
//# sourceMappingURL=baccarat.js.4f54461834ebbc1f0d83.hot-update.js.map
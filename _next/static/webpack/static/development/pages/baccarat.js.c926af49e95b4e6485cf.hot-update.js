...
/* harmony import */ var _base_container__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../base-container */ "./components/base-container.js");
/* harmony import */ var _game_counter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./game-counter */ "./components/baccarat/game-counter.js");
/* harmony import */ var _libs_eos_client__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../libs/eos-client */ "./libs/eos-client.js");
/* harmony import */ var _redux__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../redux */ "./redux/index.js");
/* harmony import */ var _libs_format_helper__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../libs/format-helper */ "./libs/format-helper.js");
/* harmony import */ var _libs_error_parser__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../libs/error-parser */ "./libs/error-parser.js");
/* harmony import */ var _token_selector__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./token-selector */ "./components/baccarat/token-selector.js");
...
var eosClient = _libs_eos_client__WEBPACK_IMPORTED_MODULE_8__["default"].getInstance();
...
function (_React$Component) {
  ...
  function PlayerArea() {
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var areaId, selectedToken, betItem, result, rngError;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this.props.dispatch(_redux__WEBPACK_IMPORTED_MODULE_9__["actions"].modal.showLoading('betting...'));

              areaId = _this.props.areaId;
              selectedToken = _redux__WEBPACK_IMPORTED_MODULE_9__["selectors"].baccaratSelectedToken(_this.props);
            ...
            case 5:
              ...
              _context.prev = 6;
              _context.next = 9;
              return eosClient.baccaratBet("".concat(PlayerArea.WAGER_TYPES[selectedToken].toFixed(4), " EOS"), 'baccarat', betItem);
            ...
            case 9:
              ...
              _redux__WEBPACK_IMPORTED_MODULE_9__["actions"].myBalanceUpdateFromRemote().then(function (balance) {
                return _this.props.dispatch(balance);
              });

              _this.props.dispatch(_redux__WEBPACK_IMPORTED_MODULE_9__["actions"].modal.closeLoading());
            ...
            case 15:
              ...
              rngError = Object(_libs_error_parser__WEBPACK_IMPORTED_MODULE_11__["default"])(_context.t0);

              _this.props.dispatch(_redux__WEBPACK_IMPORTED_MODULE_9__["actions"].modal.closeLoading());

              _this.props.dispatch(_redux__WEBPACK_IMPORTED_MODULE_9__["actions"].modal.showError(rngError));
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCurrentBets", function () {
      ...
      return _this.state.currentBets.slice(from, end).map(function (e, index) {
        ...
        var wager = lodash__WEBPACK_IMPORTED_MODULE_5___default.a.get(e, 'raw.meta.wager');
  ...
  _createClass(PlayerArea, [{
    ...
    value: function componentDidUpdate() {
      ...
      var currentBets = _redux__WEBPACK_IMPORTED_MODULE_9__["selectors"].getBaccaratCurrentBets(this.props);

      if (lodash__WEBPACK_IMPORTED_MODULE_5___default.a.isArray(currentBets)) {
        currentBets = currentBets.filter(function (_ref3) {
          var item = _ref3.item;
          return item === betItem;
        });

        if (lodash__WEBPACK_IMPORTED_MODULE_5___default.a.isEqual(this.state.currentBets, currentBets) === false) {
          this.setState({
    ...
    value: function render() {
      ...
      var styles = {
        ...
        odds: {
          marginTop: 3,
          color: _libs_styleguide_colors__WEBPACK_IMPORTED_MODULE_13__["default"].odds
        }
      };
  ...
  playerWin: {
    title: '閒',
    titleColor: _libs_styleguide_colors__WEBPACK_IMPORTED_MODULE_13__["default"].blue,
    odds: '1:1',
    betItem: 'player'
  },
  playerPair: {
    title: '閒對',
    titleColor: _libs_styleguide_colors__WEBPACK_IMPORTED_MODULE_13__["default"].white,
    odds: '1:11',
    betItem: 'player_pair',
    background: _libs_styleguide_colors__WEBPACK_IMPORTED_MODULE_13__["default"].pairBG
  },
  bankerWin: {
    title: '莊',
    titleColor: _libs_styleguide_colors__WEBPACK_IMPORTED_MODULE_13__["default"].red,
    odds: '1:0.95',
    betItem: 'banker'
  },
  bankerPair: {
  ...
  tie: {
    title: '和',
    titleColor: _libs_styleguide_colors__WEBPACK_IMPORTED_MODULE_13__["default"].mediumGreen,
    odds: '1:8',
    betItem: 'tie'
  }
...
PlayerArea.propTypes = {
  areaId: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string.isRequired,
...
function (_React$Component2) {
  ...
  function GameTable() {
    ...
    _defineProperty(_assertThisInitialized(_this2), "getCard", function (cardNumber) {
      ...
      var _decodeBaccaratCard = Object(_libs_format_helper__WEBPACK_IMPORTED_MODULE_10__["decodeBaccaratCard"])(cardNumber),
  ...
  _createClass(GameTable, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var previousBaccaratGameStatus = lodash__WEBPACK_IMPORTED_MODULE_5___default.a.get(prevProps, 'baccarat', null);

      var currentBaccaratGameStatus = lodash__WEBPACK_IMPORTED_MODULE_5___default.a.get(this.props, 'baccarat', null); // console.log('[GameTable]', { previousBaccaratGameStatus, currentBaccaratGameStatus });
      // game state changed


      if (currentBaccaratGameStatus && previousBaccaratGameStatus && previousBaccaratGameStatus.gameState !== currentBaccaratGameStatus.gameState) {
        switch (currentBaccaratGameStatus.gameState) {
          case 'BACCARAT_GAME_STATE_RESULT':
            {
              var bankerCard = currentBaccaratGameStatus.gameResult.banker_card;
              var playerCard = currentBaccaratGameStatus.gameResult.player_card;
              this.setState({
                dealArea: {
                  playerCardSeat: [this.getCard(playerCard[0]), this.getCard(playerCard[1])],
                  bankerCardSeat: [this.getCard(bankerCard[0]), this.getCard(bankerCard[0])]
                }
              });
              break;
            }
    ...
    value: function render() {
      var styles = {
        ...
        dealArea: {
          ...
          opacity: 0.37,
          borderRadius: 2,
          backgroundImage: 'linear-gradient(70deg, rgba(0, 0, 0, 0), #29ca4a)',
          textAlign: 'center',
          position: 'relative'
        },
        dealAreaTitle: {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_base_container__WEBPACK_IMPORTED_MODULE_6__["default"], {
        style: styles.root
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        style: styles.dealArea
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        style: styles.dealAreaTitle
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", null, Object(_libs_i18n_util__WEBPACK_IMPORTED_MODULE_14__["default"])('player')), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", {
        style: {
          marginLeft: 20
        }
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", null, Object(_libs_i18n_util__WEBPACK_IMPORTED_MODULE_14__["default"])('banker'))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        style: styles.dealAreaBaccaratWord
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("img", {
        ...
        item: true,
        xs: 6
      }, this.state.dealArea.playerCardSeat[1]))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__["Grid"], {
        item: true,
        xs: 2
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__["Grid"], {
        item: true,
        ...
        item: true,
        xs: 2
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_game_counter__WEBPACK_IMPORTED_MODULE_7__["default"], null), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PlayerArea, {
        areaId: 'tie',
        style: styles.tie
      })), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__["Grid"], {
        item: true,
      ...
      }))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_token_selector__WEBPACK_IMPORTED_MODULE_12__["default"], null));
    }
  }]);
...
GameTable.propTypes = {
  baccarat: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.object
};
...
//# sourceMappingURL=baccarat.js.c926af49e95b4e6485cf.hot-update.js.map
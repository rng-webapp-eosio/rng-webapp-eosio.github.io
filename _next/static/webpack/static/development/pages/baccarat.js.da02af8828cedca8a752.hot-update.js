...
function (_React$Component2) {
  ...
  _createClass(GameTable, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        dealArea: {
          playerCardSeat: [2, 5, 21].map(function (cardNumber) {
            return _this3.getCard(cardNumber);
          }),
          bankerCardSeat: [9, 30, 40].map(function (cardNumber) {
            return _this3.getCard(cardNumber);
          })
        }
      });
              ...
              this.setState({
                dealArea: {
                  playerCardSeat: playerCard.map(function (cardNumber) {
                    return _this4.getCard(cardNumber);
                  }),
...
//# sourceMappingURL=baccarat.js.da02af8828cedca8a752.hot-update.js.map
...
function (_React$Component2) {
  ...
  _createClass(GameTable, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        dealArea: {
          playerCardSeat: [2, 5, 42].map(function (cardNumber, index) {
            return _this3.getCard(cardNumber, index === 2);
          }),
          bankerCardSeat: [9, 10, 25].map(function (cardNumber, index) {
            return _this3.getCard(cardNumber, index === 2);
          })
        }
      });
...
//# sourceMappingURL=baccarat.js.be668a703290dcc7ffc1.hot-update.js.map